...
_warning_no_trace = lambda message, *args, **kwargs : print(message)
warnings.showwarning = _warning_no_trace
...
def ecc_anomaly(M, e):
    ...
    warnings.warn('No convergence in ecc_anomaly for e=%3.2f. '\
